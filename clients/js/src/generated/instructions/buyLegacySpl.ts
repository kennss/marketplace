...
export const BUY_LEGACY_SPL_DISCRIMINATOR = new Uint8Array([
  134, 94, 125, 229, 24, 157, 194, 199,
]);

export function getBuyLegacySplDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    BUY_LEGACY_SPL_DISCRIMINATOR
  );
}
...
export function getBuyLegacySplInstructionDataEncoder(): Encoder<BuyLegacySplInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: BUY_LEGACY_SPL_DISCRIMINATOR,
