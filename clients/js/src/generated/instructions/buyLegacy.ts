...
export const BUY_LEGACY_DISCRIMINATOR = new Uint8Array([
  68, 127, 43, 8, 212, 31, 249, 114,
]);

export function getBuyLegacyDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(BUY_LEGACY_DISCRIMINATOR);
}
...
export function getBuyLegacyInstructionDataEncoder(): Encoder<BuyLegacyInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: BUY_LEGACY_DISCRIMINATOR,
