...
export const TAKE_BID_LEGACY_DISCRIMINATOR = new Uint8Array([
  188, 35, 116, 108, 0, 233, 237, 201,
]);

export function getTakeBidLegacyDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    TAKE_BID_LEGACY_DISCRIMINATOR
  );
}
...
export function getTakeBidLegacyInstructionDataEncoder(): Encoder<TakeBidLegacyInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: TAKE_BID_LEGACY_DISCRIMINATOR,
